...
Item {
    ...
    Rectangle {
        id: scrMenue
        y: Qt.inputMethod.keyboardRectangle.height >0 ?Qt.inputMethod.keyboardRectangle.height -sizeHeigthConfig * 30 + sizeHeigthConfig * (8)   : sizeHeigthConfig * (8)
        z:3
    ...
    Label{
        ...
        y: Qt.inputMethod.keyboardRectangle.height >0 ?Qt.inputMethod.keyboardRectangle.height -sizeHeigthConfig * 30 + sizeHeigthConfig * 15 : sizeHeigthConfig * 15
    ...
    Rectangle {
        ...
        Text {
            ...
            x: sizeWidthConfig *38
            y: Qt.inputMethod.keyboardRectangle.height >0 ?Qt.inputMethod.keyboardRectangle.height -sizeHeigthConfig * 30  + sizeHeigthConfig *  18 : sizeHeigthConfig *  18
            color: "white"
            opacity: 0.47
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.verticalCenter: parent.verticalCenter
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                urlBilderForWebSocket ='qrc:/qml/grup/grupInfo.qml'
                peopleWhoSelectedURL = ""
                peopleWhoSelectedURL = 'qrc:/qml/grup/grupInfo.qml'
    ...
    Timer {
        ...
        onTriggered:{
            ...
            if (flickable.contentY=== 800){
                mapLoader.source =  "qrc:/qml/grup/grupInfo.qml"
                flickableUp.stop()
                flickableDown.stop()
            }
    ...
    Rectangle {
        ...
        y: Qt.inputMethod.keyboardRectangle.height >0 ?Qt.inputMethod.keyboardRectangle.height -sizeHeigthConfig * 30  + sizeHeigthConfig * (-2) : sizeHeigthConfig * (-2)
        z:3
