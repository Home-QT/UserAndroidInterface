function topInterface() {
    var massPeople = listPeopleAddToChat;
    massPeople[massPeople.length] = String(myId)
    console.log(massPeople)
    SocketManager.writeCommon('getUsers', {users: massPeople},function(err,contactGupList){
